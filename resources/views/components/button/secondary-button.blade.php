    ...
    {{
        $attributes->merge([
            ...
            'class' => '
                ...
                px-4 py-2
                bg-secondary-100 dark:bg-gray-900
                ...
                focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25
